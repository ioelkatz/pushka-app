...
//  0.0 s  Dollar bill starts slow fall from very top + bill sound
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _floodCtrl    = AnimationController(vsync: this, duration: 800.ms);
