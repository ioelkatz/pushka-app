...
class S {
  ...
  String get loading =>
      _t('Cargando...', 'Loading...', 'Chargement...', 'טוען...');
  String get fieldRequired =>
      _t('Campo requerido', 'Field required', 'Champ requis', 'שדה חובה');
  ...
  String hello(String name) =>
      _t('Hola $name', 'Hello $name', 'Bonjour $name', 'שלום $name');
  String get myPushka =>
      _t('Mi Pushka', 'My Pushka', 'Ma Pushka', 'הפושקה שלי');
  String get wallet => _t('Billetera', 'Wallet', 'Portefeuille', 'ארנק');
  String get cardNicknameTitle => _t(
    'Apodo de la tarjeta',
    'Card nickname',
    'Surnom de la carte',
    'כינוי לכרטיס',
  ...
  String get cardNicknameAddAction =>
      _t('Agregar apodo', 'Add nickname', 'Ajouter un surnom', 'הוסף כינוי');
  String get cardNicknameEditAction =>
      _t('Editar apodo', 'Edit nickname', 'Modifier le surnom', 'ערוך כינוי');
  String get skip => _t('Omitir', 'Skip', 'Ignorer', 'דלג');

  String get deleteCardLinkedAutoEmptyTitle =>
      _t('Eliminar tarjeta', 'Delete card', 'Supprimer la carte', 'מחק כרטיס');
  ...
  String get walletLastDonationTitle =>
      _t('Última donación', 'Last donation', 'Dernier don', 'התרומה האחרונה');
  ...
  String daysAgo(int n) =>
      _t('Hace $n días', '$n days ago', 'Il y a $n jours', 'לפני $n ימים');
  ...
  String get reminders =>
      _t('Recordatorios', 'Reminders', 'Rappels', 'תזכורות');
  String get history => _t('Historial', 'History', 'Historique', 'היסטוריה');
  String get settings =>
      _t('Configuración', 'Settings', 'Paramètres', 'הגדרות');
  String get prayersAndSegulot => _t(
    'Segulot y Rezos',
    'Prayers & Blessings',
  ...
  String version(String v) =>
      _t('Versión $v', 'Version $v', 'Version $v', 'גרסה $v');
  String get sponsoredBy =>
      _t('Patrocinado por el', 'Sponsored by', 'Parrainé par', 'בחסות');
  String get sponsorLine1 => _t(
    'Rabino Menachem Mendel Meer',
  ...
  String get noEmail =>
      _t('Sin correo', 'No email', 'Sans e-mail', 'ללא דוא"ל');
  ...
  String get fillIt =>
      _t('¡Llénala!', 'Fill it up!', 'Remplissez-la !', 'מלא אותה!');
  String get streakDays =>
      _t('Racha de Días', 'Day Streak', 'Série de jours', 'רצף ימים');
  String get otherAmount => _t('OTRO', 'OTHER', 'AUTRE', 'אחר');
  String get donateNowBtn =>
      _t('DONAR AHORA', 'DONATE NOW', 'FAIRE UN DON', 'תרום עכשיו');
  String get emptyPushkaBtn =>
      _t('VACIAR PUSHKA', 'EMPTY PUSHKA', 'VIDER LA PUSHKA', 'רוקן פושקה');
  String get changePushkaGoal => _t(
    'CAMBIAR META DE PUSHKA',
    'CHANGE PUSHKA GOAL',
    "CHANGER L'OBJECTIF",
    'שנה יעד פושקה',
  );
  String get addToPushka => _t(
    'AGREGAR A PUSHKA',
    'ADD TO PUSHKA',
    'AJOUTER À LA PUSHKA',
    'הוסף לפושקה',
  );
  String get chooseAmount => _t(
    'Elige un monto',
    'Choose an amount',
    'Choisissez un montant',
    'בחר סכום',
  );
  String get tapToEdit => _t(
    'Toca para editar el monto',
    'Tap to edit amount',
    'Appuyez pour modifier',
    'לחץ לעריכת הסכום',
  );
  String addedToPushka(String amount) => _t(
    '$amount agregado a tu Pushka',
    '$amount added to your Pushka',
    '$amount ajouté à votre Pushka',
    '$amount נוסף לפושקה שלך',
  );
  String get otherAmountTitle =>
      _t('Otro monto', 'Other amount', 'Autre montant', 'סכום אחר');
  String get amountHint =>
      _t('Ej: 12.50', 'E.g.: 12.50', 'Ex : 12,50', 'לדוגמה: 12.50');
  String get pushkaFull => _t(
    'Tu Pushka está llena',
    'Your Pushka is full',
    'Votre Pushka est pleine',
    'הפושקה שלך מלאה',
  );
  String get donationGoalReached => _t(
    '¡Alcanzaste tu Meta de Donación!',
    'You reached your Donation Goal!',
    'Vous avez atteint votre objectif !',
    'הגעת ליעד התרומה שלך!',
  );
  String get donateNowTitle =>
      _t('Donación segura', 'Secure donation', 'Don sécurisé', 'תרומה מאובטחת');
  String get donateOnce =>
      _t('Donar una vez', 'One time', 'Une fois', 'פעם אחת');
  String get donateMonthly => _t('Mensual', 'Monthly', 'Mensuel', 'חודשי');
  String get donateMonthlyBtn => _t(
    'Donar mensualmente',
    'Donate monthly',
    'Faire un don mensuel',
    'תרום חודשי',
  );
  String get dedicateDonation => _t(
    'Dedica esta donación',
  ...
  String get emptyAuto =>
      _t('Automático', 'Automatic', 'Automatique', 'אוטומטי');
  String get emptyFrequencyLabel =>
      _t('Frecuencia', 'Frequency', 'Fréquence', 'תדירות');
  String get emptyAutoBtn => _t(
    'Activar vaciado automático',
    'Enable auto-empty',
    'Activer le vidage automatique',
    'הפעל ריקון אוטומטי',
  ...
  String get optionalMessage => _t(
    'Mensaje personal (opcional)',
    'Personal message (optional)',
    'Message personnel (optionnel)',
    'הודעה אישית (אופציונלי)',
  );
  String get writeMessage => _t(
    'Escribe un mensaje...',
    'Write a message...',
    'Écrivez un message...',
    'כתוב הודעה...',
  ...
  String get stripeNotConfigured => _t(
    'Stripe no está configurado',
    'Stripe is not configured',
    "Stripe n'est pas configuré",
    'Stripe אינו מוגדר',
  );
  String get biometricReasonEmpty => _t(
    'Confirma tu identidad para vaciar la Pushka',
    'Confirm your identity to empty the Pushka',
    'Confirmez votre identité pour vider la Pushka',
    'אמת את זהותך כדי לרוקן את הפושקה',
  );
  String get authRequired => _t(
    'Autenticación requerida para vaciar la Pushka',
    'Authentication required to empty the Pushka',
    'Authentification requise pour vider la Pushka',
    'נדרש אימות לריקון הפושקה',
  );
  String get pushkaEmptied => _t(
    'Pushka vaciada. El pago fue procesado.',
    'Pushka emptied. Payment was processed.',
    'Pushka vidée. Le paiement a été traité.',
    'הפושקה רוקנה. התשלום עובד.',
  );
  String get pushkaEmptyHint => _t(
    'Tu pushka está vacía. Agrega algo primero.',
    'Your pushka is empty. Add something first.',
    "Ta pushka est vide. Ajoute quelque chose d'abord.",
    'הפושקה שלך ריקה. הוסף משהו קודם.',
  );
  String get couldNotEmpty => _t(
    'No se pudo vaciar la Pushka',
    'Could not empty the Pushka',
    'Impossible de vider la Pushka',
    'לא ניתן לרוקן את הפושקה',
  );
  String get biometricReasonDonate => _t(
    'Confirma tu identidad para procesar la donación',
    'Confirm your identity to process the donation',
    'Confirmez votre identité pour traiter le don',
    'אמת את זהותך לעיבוד התרומה',
  );
  String get authRequiredDonate => _t(
    'Autenticación requerida para donar',
    'Authentication required to donate',
    'Authentification requise pour faire un don',
    'נדרש אימות לתרומה',
  );
  String get instantDonation => _t(
    'Donación instantánea',
    'Instant donation',
    'Don instantané',
    'תרומה מיידית',
  );
  String donationProcessed(String amount) => _t(
    'Donación de $amount procesada exitosamente',
    'Donation of $amount processed successfully',
    'Don de $amount traité avec succès',
    'תרומה של $amount עובדה בהצלחה',
  );
  String get donationWithCard => _t(
    'Donación con tarjeta',
    'Card donation',
    'Don par carte',
    'תרומה בכרטיס',
  );
  String paymentProcessedRemaining(String amount) => _t(
    'Pago procesado. Quedaron $amount en la Pushka.',
    'Payment processed. $amount remaining in the Pushka.',
    'Paiement traité. $amount restant dans la Pushka.',
    'התשלום עובד. נותרו $amount בפושקה.',
  );
  String get paymentProcessedHistory => _t(
    'Pago procesado. Se reflejará en el historial pronto.',
    'Payment processed. It will appear in your history soon.',
    "Paiement traité. Il apparaîtra bientôt dans l'historique.",
    'התשלום עובד. יופיע בהיסטוריה בקרוב.',
  );
  String get minAmountTitle =>
      _t('Monto mínimo', 'Minimum amount', 'Montant minimum', 'סכום מינימום');
  ...
  String get maxAmountTitle =>
      _t('Monto máximo', 'Maximum amount', 'Montant maximum', 'סכום מקסימלי');
  ...
  String get couldNotStartPayment => _t(
    "No se pudo iniciar el pago",
    "Could not start payment",
    "Impossible de lancer le paiement",
    'לא ניתן להתחיל את התשלום',
  );
  String get paymentCanceled => _t(
    'Pago cancelado',
    'Payment canceled',
    'Paiement annulé',
    'התשלום בוטל',
  );
  String paymentFailed(String msg) => _t(
    'No se pudo completar el pago: $msg',
    'Could not complete payment: $msg',
    'Impossible de compléter le paiement : $msg',
    'לא ניתן להשלים את התשלום: $msg',
  );
  String get couldNotCompleteDonation => _t(
    "No se pudo completar la donación",
    "Could not complete the donation",
    "Impossible de compléter le don",
    'לא ניתן להשלים את התרומה',
  );
  ...
  String get donationRetryBtn =>
      _t('Reintentar', 'Retry', 'Réessayer', 'נסה שוב');
  String get donationContactRabBtn => _t(
    'Contactar al rab',
    'Contact rabbi',
    'Contacter le rabbin',
    'צור קשר עם הרב',
  ...
  String get partialDonationTitle =>
      _t('Donación parcial', 'Partial donation', 'Don partiel', 'תרומה חלקית');
  String availableInPushka(String amount) => _t(
    'Disponible en Pushka: $amount',
    'Available in Pushka: $amount',
    'Disponible dans la Pushka : $amount',
    'זמין בפושקה: $amount',
  );
  String get quickSelect => _t(
    'Selecciona rápido',
    'Quick select',
    'Sélection rapide',
    'בחירה מהירה',
  );
  String get amountToDonate => _t(
    'Monto a donar ahora',
    'Amount to donate now',
    'Montant à donner maintenant',
    'סכום לתרומה עכשיו',
  );
  String get donate => _t('Donar', 'Donate', 'Donner', 'תרום');
  String get cannotExceedBalance => _t(
    'No puede ser mayor al saldo de tu Pushka',
    'Cannot exceed your Pushka balance',
    'Ne peut pas dépasser le solde de votre Pushka',
    'לא יכול לעלות על יתרת הפושקה שלך',
  );
  String get tzedakahSettings => _t(
    'Configuración de Tzedaká',
    'Tzedakah Settings',
    'Configuration de Tsédaka',
    'הגדרות צדקה',
  );
  String get donationReasonTitle =>
      _t('Designación', 'Designation', 'Désignation', 'ייעוד');
  String get donationReasonSubtitle => _t(
    'Opcional — elige a qué destino va tu donación.',
    'Optional — choose where your donation goes.',
    'Optionnel — choisissez la destination de votre don.',
    'אופציונלי — בחרו לאן הולכת התרומה.',
  );
  String get donationReasonNone =>
      _t('Sin designación', 'No designation', 'Sans désignation', 'ללא ייעוד');
  String get donationReasonWhereNeeded => _t(
    'Donde se necesite más',
    'Where most needed',
    'Là où c\'est le plus nécessaire',
    'במקום שהכי נחוץ',
  );
  String get donationReasonFamilies => _t(
    'Familias necesitadas',
    'Families in need',
    'Familles dans le besoin',
    'משפחות נזקקות',
  );
  String get donationReasonTorah =>
      _t('Estudio de Torá', 'Torah study', 'Étude de la Torah', 'לימוד תורה');
  String get donationReasonHolidays =>
      _t('Festividades', 'Holidays', 'Fêtes', 'חגים');
  String get donationMessageLabel => _t(
    'Mensaje (opcional)',
    'Message (optional)',
    'Message (optionnel)',
    'הודעה (אופציונלי)',
  );
  String get donationMessageHint => _t(
    'Dejá un mensaje, oración o dedicatoria',
    'Leave a message, prayer or dedication',
    'Laissez un message, une prière ou une dédicace',
    'השאר הודעה, תפילה או הקדשה',
  );
  ...
  String get pushkaGoalLabel =>
      _t('META DE PUSHKA', 'PUSHKA GOAL', 'OBJECTIF DE PUSHKA', 'יעד פושקה');
  String get correctAmountLabel => _t(
    'MONTO ACUMULADO',
    'ACCUMULATED AMOUNT',
    'MONTANT ACCUMULÉ',
    'סכום שנצבר',
  );
  String get correctAmountHint => _t(
    '¿Pusiste de más? Corregí el monto acumulado.',
    'Added too much? Correct the accumulated amount.',
    'Trop ajouté ? Corrigez le montant accumulé.',
    'הוספת יותר מדי? תקן את הסכום שנצבר.',
  );
  String get correctAmountDialogTitle => _t(
    'Corregir monto acumulado',
    'Correct accumulated amount',
    'Corriger le montant accumulé',
    'תקן סכום שנצבר',
  );
  String get correctAmountUpdated => _t(
    'Monto corregido',
    'Amount corrected',
    'Montant corrigé',
    'הסכום תוקן',
  );
  String get presetAmountsLabel => _t(
    'MONTOS PREDEFINIDOS',
    'PRESET AMOUNTS',
    'MONTANTS PRÉDÉFINIS',
    'סכומים קבועים מראש',
  );
  String get editQuickAmountHint => _t(
    'Edita los montos que aparecen como botones rápidos',
    'Edit the amounts that appear as quick buttons',
    'Modifiez les montants des boutons rapides',
    'ערוך את הסכומים המופיעים כלחצנים מהירים',
  );
  String get allAmountsMustBePositive => _t(
    'Todos los montos deben ser mayores a 0',
    'All amounts must be greater than 0',
    'Tous les montants doivent être supérieurs à 0',
    'כל הסכומים חייבים להיות גדולים מ-0',
  );
  String get settingsApplied => _t(
    'Configuración aplicada',
    'Settings applied',
    'Paramètres appliqués',
    'הגדרות הוחלו',
  );
  String get customGoal => _t(
    'Meta personalizada',
    'Custom goal',
  ...
  String get customGoalHint =>
      _t('Ej: 4500', 'E.g.: 4500', 'Ex : 4500', 'לדוגמה: 4500');
  String get offlineMessage => _t(
    ...
    'לא מקוון — חלק מהנתונים עשויים להיות לא מעודכנים',
  );
  String get offlineDonationBlocked => _t(
    'Necesitas conexión a internet para procesar el pago. Verifica tu WiFi o datos.',
    'You need an internet connection to process the payment. Check your WiFi or mobile data.',
    'Vous avez besoin d\'une connexion internet pour traiter le paiement. Vérifiez votre WiFi ou vos données mobiles.',
    'נדרש חיבור לאינטרנט לעיבוד התשלום. בדוק את ה-WiFi או הנתונים שלך.',
  );
  String get offlineDialogTitle =>
      _t('Sin conexión', 'Offline', 'Hors ligne', 'לא מקוון');
  ...
  String get pushkaEmptyCardDesc => _t(
    'Pushka vaciada - pago con tarjeta',
    'Pushka emptied - card payment',
    'Pushka vidée - paiement par carte',
    'פושקה רוקנה - תשלום בכרטיס',
  );
  ...
  String get holidayRoshHashana =>
      _t('Rosh Hashaná', 'Rosh Hashanah', 'Roch Hachana', 'ראש השנה');
  String get holidayRoshHashanaBanner =>
      _t('R. Hashaná', 'R. Hashanah', 'R. Hachana', 'ראש השנה');
  ...
  String get holidayYomKippur =>
      _t('Yom Kipur', 'Yom Kippur', 'Yom Kippour', 'יום כיפור');
  ...
  String get addFunds =>
      _t('Agregar fondos', 'Add funds', 'Ajouter des fonds', 'הוסף כספים');
  String get enterAmount =>
      _t('Ingresa monto', 'Enter amount', 'Entrez le montant', 'הכנס סכום');
  String get addToBalance => _t(
    'Agregar al saldo',
    'Add to balance',
    'Ajouter au solde',
    'הוסף ליתרה',
  );
  String fundsAdded(String amount) => _t(
    'Fondos agregados: $amount',
    'Funds added: $amount',
    'Fonds ajoutés : $amount',
    'כספים נוספו: $amount',
  );
  ...
  String get learnMore =>
      _t('Aprender más', 'Learn more', 'En savoir plus', 'למידע נוסף');
  String get balanceLabel => _t('SALDO', 'BALANCE', 'SOLDE', 'יתרה');
  String get addFundsBtn => _t(
    '+ Agregar fondos',
    '+ Add funds',
    '+ Ajouter des fonds',
    '+ הוסף כספים',
  ...
  String get sendRequest => _t(
    'Enviar / Solicitar entre billeteras',
    'Send / Request between wallets',
    'Envoyer / Demander entre portefeuilles',
    'שלח / בקש בין ארנקים',
  );
  String get sendRequestSub => _t(
    'Empodera a familia y amigos con tzedaká',
    'Empower family and friends with tzedakah',
    'Responsabilisez famille et amis avec la tsédaka',
    'העצם משפחה וחברים עם צדקה',
  );
  String get manageAutoRefill => _t(
    'Administrar recarga automática',
    'Manage auto refill',
    'Gérer la recharge automatique',
    'נהל טעינה אוטומטית',
  );
  String get transactionHistory => _t(
    'Historial de transacciones',
    'Transaction history',
    'Historique des transactions',
    'היסטוריית עסקאות',
  );
  String autoRefillActive(String amount, String freq) => _t(
    'ACTIVA - $amount $freq',
    'ACTIVE - $amount $freq',
    'ACTIF - $amount $freq',
    'פעיל - $amount $freq',
  );
  String get autoRefillInactive => _t(
    'RECARGA AUTOMÁTICA INACTIVA',
    'AUTO REFILL INACTIVE',
    'RECHARGE AUTOMATIQUE INACTIVE',
    'טעינה אוטומטית לא פעילה',
  );
  String nextRun(String date) =>
      _t('Próxima: $date', 'Next: $date', 'Prochaine : $date', 'הבא: $date');
  ...
  String get pushkaGoalSetting =>
      _t('META DE PUSHKA', 'PUSHKA GOAL', 'OBJECTIF DE PUSHKA', 'יעד פושקה');
  String get presetAmount => _t(
    'MONTO PREESTABLECIDO',
    'PRESET AMOUNT',
    'MONTANT PRÉDÉFINI',
    'סכום קבוע מראש',
  );
  String get emptyPushkaSetting =>
      _t('VACIAR PUSHKA', 'EMPTY PUSHKA', 'VIDER LA PUSHKA', 'רוקן פושקה');
  String get manualEmpty =>
      _t('Vaciar Manualmente', 'Manual Empty', 'Vidage manuel', 'ריקון ידני');
  ...
  String get ambientMusic =>
      _t('MÚSICA AMBIENTAL', 'AMBIENT MUSIC', 'MUSIQUE AMBIANTE', 'מוזיקת רקע');
  String get ambientMusicSub => _t(
    'Nigunim jasídicos de fondo',
    'Hasidic nigunim in the background',
    'Nigunim hassidiques en fond',
    'ניגונים חסידיים ברקע',
  );
  String get partialPayments => _t(
    'PAGOS PARCIALES',
    'PARTIAL PAYMENTS',
    'PAIEMENTS PARTIELS',
    'תשלומים חלקיים',
  ...
  String get biometricActivated => _t(
  ...
  String get fingerprint =>
      _t('Huella digital', 'Fingerprint', 'Empreinte digitale', 'טביעת אצבע');
  String get faceRecognition => _t(
    'Reconocimiento facial',
    'Face recognition',
    'Reconnaissance faciale',
    'זיהוי פנים',
  );
  String get pinPattern =>
      _t('PIN / Patrón', 'PIN / Pattern', 'PIN / Schéma', 'PIN / דפוס');
  String get myPushkaSection =>
      _t('MI PUSHKA', 'MY PUSHKA', 'MA PUSHKA', 'הפושקה שלי');
  String get addPushkaBtn => _t(
    '+ Agregar Pushka',
    '+ Add Pushka',
    '+ Ajouter Pushka',
    '+ הוסף פושקה',
  );
  String get signInToSeePushkas => _t(
    'Inicia sesión para ver tus Pushkas',
    'Sign in to see your Pushkas',
    'Connectez-vous pour voir vos Pushkas',
    'התחבר כדי לראות את הפושקות שלך',
  );
  String get errorLoadingPushkas => _t(
    'No se pudieron cargar las Pushkas',
    'Could not load Pushkas',
    'Impossible de charger les Pushkas',
    'לא ניתן לטעון את הפושקות',
  );
  String get defaultPushkaName => _t(
    'Pushka Jabad en Campus',
    'Chabad on Campus Pushka',
    'Pushka Habad sur le Campus',
    'פושקה חב"ד בקמפוס',
  );
  ...
  String get deleteAccountQuestion => _t(
    '¿Eliminar cuenta?',
    'Delete account?',
    'Supprimer le compte ?',
    'מחק חשבון?',
  );
  String get exportMyData => _t(
    'Exportar mis datos',
    'Export my data',
    'Exporter mes données',
    'ייצוא הנתונים שלי',
  );
  String get exportInProgress => _t(
  ...
  String get searchCountry =>
      _t('Buscar país', 'Search country', 'Rechercher un pays', 'חפש מדינה');
  String get nameOrCode =>
      _t('Nombre o código', 'Name or code', 'Nom ou code', 'שם או קוד');
  ...
  String enterField(String field) =>
      _t('Ingresa $field', 'Enter $field', 'Entrez $field', 'הכנס $field');
  ...
  String get couldNotDeleteAccount => _t(
  ...
  String get requiresRecentLogin => _t(
    ...
    'מטעמי אבטחה, התחבר שוב לפני מחיקת החשבון.',
  );
  String get deleteConfirmWord => _t('ELIMINAR', 'DELETE', 'SUPPRIMER', 'מחק');
  String deleteTypeInstruction(String word) => _t(
    'Escribe $word para confirmar',
    'Type $word to confirm',
    'Écrivez $word pour confirmer',
    'כתוב $word לאישור',
  );
  String get verifyIdentityTitle => _t(
    'Verificar identidad',
    'Verify identity',
    'Vérifier l\'identité',
    'אמת זהות',
  );
  String get verifyIdentityBody => _t(
    'Para mayor seguridad, confirma tu identidad antes de eliminar tu cuenta.',
    'For security, confirm your identity before deleting your account.',
    'Pour votre sécurité, confirmez votre identité avant de supprimer votre compte.',
    'לאבטחתך, אמת את זהותך לפני מחיקת החשבון.',
  );
  String get reAuthFailed => _t(
    'No se pudo verificar la identidad',
    'Could not verify identity',
    'Impossible de vérifier l\'identité',
    'לא ניתן לאמת זהות',
  );
  String get verifyAndDelete => _t(
  ...
  String get logoutTitle =>
      _t('Cerrar Sesión', 'Log Out', 'Déconnexion', 'התנתקות');
  ...
  String get sessionClosed =>
      _t('Sesión cerrada', 'Session closed', 'Session fermée', 'הסשן נסגר');
  String get pushkaGoalDialog =>
      _t('Meta de Pushka', 'Pushka Goal', 'Objectif de Pushka', 'יעד פושקה');
  String get exampleGoalHint =>
      _t('Ej: 3600.00', 'E.g.: 3600.00', 'Ex : 3600,00', 'לדוגמה: 3600.00');
  String get emptyPushkaFirst => _t(
    'Vacía tu Pushka primero',
    'Empty your Pushka first',
    "Videz d'abord votre Pushka",
    'רוקן את הפושקה קודם',
  );
  ...
  String get changeCurrencyTitle =>
      _t('Cambiar moneda', 'Change currency', 'Changer de devise', 'שנה מטבע');
  ...
  String get enterPushkaId => _t(
    'Ingresar ID Pushka',
    'Enter Pushka ID',
    "Entrer l'ID Pushka",
    'הכנס מזהה פושקה',
  );
  String get pushkaIdHint => _t(
    'Ingresa ID Pushka',
    'Enter Pushka ID',
    "Entrez l'ID Pushka",
    'הכנס מזהה פושקה',
  );
  String get invalidPushkaId => _t(
    'Ingresa un ID de Pushka válido',
    'Enter a valid Pushka ID',
    'Entrez un ID Pushka valide',
    'הכנס מזהה פושקה תקין',
  );
  String get pushkaAdded =>
      _t('Pushka agregada', 'Pushka added', 'Pushka ajoutée', 'פושקה נוספה');
  String get addNewPushka => _t(
    'Agregar nueva Pushka',
    'Add new Pushka',
    'Ajouter une nouvelle Pushka',
    'הוסף פושקה חדשה',
  );
  String get enterValidId => _t(
  ...
  String get noReminders =>
      _t('No hay recordatorios', 'No reminders', 'Aucun rappel', 'אין תזכורות');
  String get tapToAddReminder => _t(
    'Toca el botón para agregar uno',
    'Tap the button to add one',
    "Appuyez sur le bouton pour en ajouter",
    'לחץ על הכפתור להוספה',
  );
  String get errorLoadingReminders => _t(
    'Error cargando recordatorios',
    'Error loading reminders',
    'Erreur de chargement des rappels',
    'שגיאה בטעינת תזכורות',
  );
  String get addReminder => _t(
    '+ AGREGAR RECORDATORIO',
    '+ ADD REMINDER',
    '+ AJOUTER UN RAPPEL',
    '+ הוסף תזכורת',
  );
  String get deleteReminderTitle => _t(
    'Eliminar recordatorio',
    'Delete reminder',
    'Supprimer le rappel',
    'מחק תזכורת',
  );
  String deleteReminderConfirm(String title) => _t(
    '¿Eliminar "$title"?',
    'Delete "$title"?',
    'Supprimer "$title" ?',
    'למחוק "$title"?',
  );
  String get reminderAdded => _t(
    'Recordatorio agregado',
    'Reminder added',
    'Rappel ajouté',
    'תזכורת נוספה',
  );
  String get reminderUpdated => _t(
    'Recordatorio actualizado',
    'Reminder updated',
    'Rappel mis à jour',
    'תזכורת עודכנה',
  );
  String get signInToSaveReminders => _t(
    'Inicia sesión para guardar recordatorios',
    'Sign in to save reminders',
    'Connectez-vous pour enregistrer les rappels',
    'התחבר כדי לשמור תזכורות',
  );
  String get couldNotSaveReminder => _t(
    "No se pudo guardar el recordatorio",
    "Could not save reminder",
    "Impossible d'enregistrer le rappel",
    'לא ניתן לשמור את התזכורת',
  );
  String get couldNotUpdateReminder => _t(
    "No se pudo actualizar el recordatorio",
    "Could not update reminder",
    "Impossible de mettre à jour le rappel",
    'לא ניתן לעדכן את התזכורת',
  );
  String get signInToModify => _t(
    'Inicia sesión para modificar recordatorios',
    'Sign in to modify reminders',
    'Connectez-vous pour modifier les rappels',
    'התחבר כדי לשנות תזכורות',
  );
  String get signInToDelete => _t(
    'Inicia sesión para eliminar recordatorios',
    'Sign in to delete reminders',
    'Connectez-vous pour supprimer les rappels',
    'התחבר כדי למחוק תזכורות',
  );
  ...
  String get enableNotificationsPrimary =>
      _t('Activar', 'Enable', 'Activer', 'הפעל');
  String get enableNotificationsSecondary =>
      _t('Ahora no', 'Not now', 'Pas maintenant', 'לא עכשיו');
  ...
  String get repeatWeekdays =>
      _t('Días de semana', 'Weekdays', 'Jours ouvrables', 'ימי חול');
  String get repeatFridayHoliday => _t(
    'Viernes y festivos',
    'Friday & Holidays',
    'Vendredi et fêtes',
    'שישי וחגים',
  );
  String get repeatChooseDate =>
      _t('Elegir una fecha', 'Choose a date', 'Choisir une date', 'בחר תאריך');
  String get repeatCustom =>
      _t('Personalizado', 'Custom', 'Personnalisé', 'מותאם אישית');
  String get editReminder => _t(
    'Editar Recordatorio',
    'Edit Reminder',
    'Modifier le rappel',
    'ערוך תזכורת',
  ...
  String get newReminder =>
      _t('Nuevo Recordatorio', 'New Reminder', 'Nouveau rappel', 'תזכורת חדשה');
  String get labelSection => _t('ETIQUETA', 'LABEL', 'ÉTIQUETTE', 'תווית');
  String get reminderTitleHint => _t(
  ...
  String get includeHolidays => _t(
    'Incluir festivos',
    'Include holidays',
    'Inclure les jours fériés',
    'כלול חגים',
  );
  String get secondTimeSection =>
      _t('SEGUNDO HORARIO', 'SECOND TIME', 'DEUXIÈME HEURE', 'שעה שנייה');
  String get addSecondTime => _t(
    'Agregar segundo horario',
    'Add second time',
    'Ajouter une deuxième heure',
    'הוסף שעה שנייה',
  );
  String get secondTimeLabel =>
      _t('Segunda hora', 'Second time', 'Deuxième heure', 'שעה שנייה');
  String get advanceNoticeSection =>
      _t('AVISO PREVIO', 'ADVANCE NOTICE', 'PRÉAVIS', 'התראה מוקדמת');
  String get atExactTime => _t(
    'A la hora exacta',
    'At exact time',
    'À l\'heure exacte',
    'בשעה המדויקת',
  );
  String get minutesBefore30 => _t(
    '30 minutos antes',
    '30 minutes before',
    '30 minutes avant',
    '30 דקות לפני',
  );
  String get minutesBefore60 =>
      _t('1 hora antes', '1 hour before', '1 heure avant', 'שעה לפני');
  String get minutesBefore90 => _t(
    '1h 30min antes',
    '1.5 hours before',
    '1h 30min avant',
    'שעה וחצי לפני',
  );
  String get minutesBefore120 =>
      _t('2 horas antes', '2 hours before', '2 heures avant', 'שעתיים לפני');
  String get presetsFromMain => _t(
    'Editables con ⚙ en la pantalla principal',
    'Editable with ⚙ on main screen',
    'Modifiable avec ⚙ sur l\'écran principal',
    'ניתן לעריכה עם ⚙ במסך הראשי',
  );
  ...
  String get selectDateRequired => _t(
    'Selecciona una fecha',
    'Select a date',
    'Sélectionnez une date',
    'בחר תאריך',
  );
  String get selectDayOrHoliday => _t(
    'Selecciona al menos un día o festivos',
    'Select at least one day or holidays',
    'Sélectionnez au moins un jour ou les jours fériés',
    'בחר לפחות יום אחד או חגים',
  );
  String get enterTitle =>
      _t('Ingresa un título', 'Enter a title', 'Entrez un titre', 'הכנס כותרת');
  String get titleTooShort => _t(
    'Título muy corto',
    'Title too short',
    'Titre trop court',
    'הכותרת קצרה מדי',
  ...
  String get filterTzedaka =>
      _t('Mi Tzedaka', 'My Tzedakah', 'Ma Tsédaka', 'הצדקה שלי');
  String get filterPushkaEmpty =>
      _t('Pushka Vacía', 'Pushka Empty', 'Pushka vidée', 'פושקה ריקה');
  ...
  String get noTransactionsSubtitle => _t(
    'Tus donaciones aparecerán aquí',
    'Your donations will appear here',
    'Vos dons apparaîtront ici',
    'התרומות שלך יופיעו כאן',
  );
  String get noContactsSubtitle => _t(
    'Agregá tu primer contacto con el botón +',
    'Add your first contact with the + button',
    'Ajoutez votre premier contact avec le bouton +',
    'הוסף את הקשר הראשון שלך עם כפתור +',
  );
  String get errorLoadingHistory => _t(
  ...
  String get historyDescription =>
      _t('Descripción', 'Description', 'Description', 'תיאור');
  ...
  String get loadMore =>
      _t('Cargar más', 'Load more', 'Charger plus', 'טען עוד');
  ...
  String get typeTzedaka =>
      _t('Mi Tzedaka', 'My Tzedakah', 'Ma Tsédaka', 'הצדקה שלי');
  String get typePushkaEmpty =>
      _t('Pushka Vacía', 'Pushka Empty', 'Pushka vidée', 'פושקה ריקה');
  ...
  String get methodTransfer =>
      _t('Transferencia', 'Transfer', 'Virement', 'העברה');
  String get methodDaf => _t('DAF', 'DAF', 'DAF', 'DAF');
  String get methodAuto =>
      _t('Automático', 'Automatic', 'Automatique', 'אוטומטי');
  String get statusCompleted =>
      _t('Completado', 'Completed', 'Terminé', 'הושלם');
  String get statusPending => _t('Pendiente', 'Pending', 'En attente', 'ממתין');
  String get statusConfirmed =>
      _t('Confirmado', 'Confirmed', 'Confirmé', 'אושר');
  ...
  String get weekdaysLabel =>
      _t('Días de Semana', 'Weekdays', 'Jours ouvrables', 'ימי חול');
  String get everyDay =>
      _t('Todos los días', 'Every day', 'Tous les jours', 'כל יום');
  String get holidays => _t('Festivos', 'Holidays', 'Jours fériés', 'חגים');
  String minBefore(String n) =>
      _t('$n min antes', '$n min before', '$n min avant', '$n דקות לפני');
  ...
  String get passwordField =>
      _t('Contraseña', 'Password', 'Mot de passe', 'סיסמה');
  ...
  String get continueGoogle => _t(
    'Continuar con Google',
    'Continue with Google',
    'Continuer avec Google',
    'המשך עם Google',
  );
  String get continueApple => _t(
    'Continuar con Apple',
    'Continue with Apple',
  ...
  String get createAccount =>
      _t('Crear cuenta', 'Create account', 'Créer un compte', 'צור חשבון');
  String signInError(String e) => _t(
  ...
  String genericError(String e) =>
      _t('Error: $e', 'Error: $e', 'Erreur : $e', 'שגיאה: $e');
  String googleError(String e) => _t(
    'Error con Google: $e',
    'Google error: $e',
    'Erreur Google : $e',
    'שגיאת Google: $e',
  );
  String appleError(String e) => _t(
    'Error con Apple: $e',
    'Apple error: $e',
    'Erreur Apple : $e',
    'שגיאת Apple: $e',
  ...
  String get min6Chars => _t(
    'Mínimo 6 caracteres',
    'Minimum 6 characters',
    '6 caractères minimum',
    'מינימום 6 תווים',
  );
  String get emailNotValid => _t(
  ...
  String get noAccountWithEmail => _t(
    'No existe una cuenta con ese correo',
    'No account exists with that email',
    "Aucun compte n'existe avec cet e-mail",
    'לא קיים חשבון עם הדוא"ל הזה',
  );
  String get wrongPassword => _t(
  ...
  String signInErrorCode(String code) => _t(
    'Error al iniciar sesión: $code',
    'Sign in error: $code',
    'Erreur de connexion : $code',
    'שגיאת התחברות: $code',
  );
  ...
  String get createAccountTitle =>
      _t('Crear cuenta', 'Create Account', 'Créer un compte', 'צור חשבון');
  String get createYourAccount => _t(
    'Crea tu cuenta',
    'Create your account',
    'Créez votre compte',
    'צור את החשבון שלך',
  );
  String get completeData => _t(
    'Completa tus datos para comenzar',
    'Complete your data to get started',
    'Complétez vos données pour commencer',
    'השלם את הפרטים שלך כדי להתחיל',
  );
  String get fullName =>
      _t('Nombre completo', 'Full name', 'Nom complet', 'שם מלא');
  String createAccountError(String e) => _t(
    'Error al crear cuenta: $e',
    'Error creating account: $e',
    'Erreur de création de compte : $e',
    'שגיאה ביצירת חשבון: $e',
  );
  ...
  String createAccountErrorCode(String code) => _t(
    'Error al crear cuenta: $code',
    'Error creating account: $code',
    'Erreur de création de compte : $code',
    'שגיאה ביצירת חשבון: $code',
  );
  ...
  String get back => _t('Atrás', 'Back', 'Retour', 'חזור');
  ...
  String get passwordNeedsUppercase => _t(
    ...
    'חייב לכלול לפחות אות גדולה אחת',
  );
  ...
  String get appVersionSection => _t(
    'VERSIÓN DE LA APP',
    'APP VERSION',
    "VERSION DE L'APP",
    'גרסת האפליקציה',
  ...
  String get developedBy =>
      _t('DESARROLLADO POR', 'DEVELOPED BY', 'DÉVELOPPÉ PAR', 'פותח על ידי');
  ...
  String aboutTitleFor(String brand) => _t(
    'Acerca de $brand',
    'About $brand',
    'À propos de $brand',
    'אודות $brand',
  ...
  String get autoEmpty =>
      _t('Auto Vaciar', 'Auto Empty', 'Vidage automatique', 'ריקון אוטומטי');
  String get autoEmptyLabel =>
      _t('Auto Vaciado', 'Auto Empty', 'Vidage automatique', 'ריקון אוטומטי');
  String get activated => _t('Activado', 'Activated', 'Activé', 'מופעל');
  String get deactivated =>
      _t('Desactivado', 'Deactivated', 'Désactivé', 'מושבת');
  ...
  String get freqErevRosh => _t(
    'Erev Rosh Jódesh',
    'Erev Rosh Chodesh',
    "Veille de Roch 'Hodech",
    'ערב ראש חודש',
  );
  String get dayOfWeek => _t(
    'Día de la semana',
    'Day of the week',
    'Jour de la semaine',
    'יום בשבוע',
  ...
  String get dayOfMonth =>
      _t('Día del mes', 'Day of the month', 'Jour du mois', 'יום בחודש');
  ...
  String nextEmpty(String date) => _t(
    'Próximo vaciado: $date',
    'Next empty: $date',
    'Prochain vidage : $date',
    'ריקון הבא: $date',
  );
  String get notScheduled =>
      _t('No programado', 'Not scheduled', 'Non programmé', 'לא מתוזמן');
  String get pushkaTopOff => _t(
    'Relleno de Pushka',
    'Pushka Top Off',
    'Remplissage de la Pushka',
    'השלמת פושקה',
  );
  ...
  String get autoEmptyConsentTitle =>
      _t('Autorización', 'Authorization', 'Autorisation', 'אישור');
  ...
  String get autoEmptyConsentCancel =>
      _t('Cancelar', 'Cancel', 'Annuler', 'ביטול');
  String get cardForAutoEmpty => _t(
    'Tarjeta para el cobro automático',
    'Card for automatic charge',
    'Carte pour le prélèvement automatique',
    'כרטיס לחיוב אוטומטי',
  );
  ...
  String get autoRefillSaved => _t(
    'Recarga automática guardada',
    'Auto refill saved',
    'Recharge automatique enregistrée',
    'טעינה אוטומטית נשמרה',
  );
  String couldNotSaveError(String e) => _t(
  ...
  String get contactAdded =>
      _t('Contacto agregado', 'Contact added', 'Contact ajouté', 'קשר נוסף');
  String get verification =>
      _t('Verificación', 'Verification', 'Vérification', 'אימות');
  ...
  String get yourContacts =>
      _t('TUS CONTACTOS', 'YOUR CONTACTS', 'VOS CONTACTS', 'הקשרים שלך');
  String get signInForContacts => _t(
    'Inicia sesión para ver tus contactos',
    'Sign in to see your contacts',
    'Connectez-vous pour voir vos contacts',
    'התחבר כדי לראות את הקשרים שלך',
  );
  String get errorLoadingContacts => _t(
  ...
  String get noContacts =>
      _t('Sin contactos', 'No contacts', 'Aucun contact', 'אין קשרים');
  String get defaultContact => _t('Contacto', 'Contact', 'Contact', 'קשר');
  String idPrefix(String id) =>
      _t('ID: $id', 'ID: $id', 'ID : $id', 'מזהה: $id');
  String get send => _t('ENVIAR', 'SEND', 'ENVOYER', 'שלח');
  String get request => _t('SOLICITAR', 'REQUEST', 'DEMANDER', 'בקש');
  String sent(String amount, String id) => _t(
    'Enviado $amount a $id',
    'Sent $amount to $id',
    'Envoyé $amount à $id',
    'נשלח $amount ל-$id',
  );
  String requestSent(String amount) => _t(
    'Solicitud de $amount enviada',
    'Request for $amount sent',
    'Demande de $amount envoyée',
    'בקשה של $amount נשלחה',
  );
  ...
  String get couldNotTransfer => _t(
    'No se pudo completar la transferencia',
    'Could not complete the transfer',
    'Impossible de compléter le transfert',
    'לא ניתן להשלים את ההעברה',
  );
  String get couldNotSendRequest => _t(
    'No se pudo enviar la solicitud',
    'Could not send the request',
    'Impossible d\'envoyer la demande',
    'לא ניתן לשלוח את הבקשה',
  );
  String get couldNotAddContact => _t(
    'No se pudo agregar el contacto',
    'Could not add the contact',
    'Impossible d\'ajouter le contact',
    'לא ניתן להוסיף את הקשר',
  );
  String get cannotAddSelf => _t(
    'No puedes agregar tu propia billetera como contacto',
    'You cannot add your own wallet as a contact',
    'Vous ne pouvez pas ajouter votre propre portefeuille comme contact',
    'אינך יכול להוסיף את הארנק שלך עצמך כקשר',
  );
  String get couldNotConfirmTopUp => _t(
    'No se pudo confirmar la recarga',
    'Could not confirm the top-up',
    'Impossible de confirmer la recharge',
    'לא ניתן לאשר את הטעינה',
  );
  ...
  String get pendingRequests => _t(
    'Solicitudes pendientes',
    'Pending requests',
    'Demandes en attente',
    'בקשות ממתינות',
  );
  String get noPendingRequests => _t(
    'No tienes solicitudes pendientes',
    'No pending requests',
    'Aucune demande en attente',
    'אין בקשות ממתינות',
  );
  String requestFrom(String walletId) => _t(
    'Solicitud de $walletId',
    'Request from $walletId',
    'Demande de $walletId',
    'בקשה מ-$walletId',
  );
  String requestAmount(String amount) => _t(
    'Monto: $amount',
    'Amount: $amount',
    'Montant : $amount',
    'סכום: $amount',
  ...
  String get requestAccepted => _t(
    'Solicitud aceptada. Fondos enviados.',
    'Request accepted. Funds sent.',
    'Demande acceptée. Fonds envoyés.',
    'הבקשה אושרה. הכספים נשלחו.',
  );
  String get requestRejected => _t(
    'Solicitud rechazada',
    'Request rejected',
    'Demande rejetée',
    'הבקשה נדחתה',
  );
  String get confirmAcceptRequest =>
      _t('Confirmar envío', 'Confirm send', 'Confirmer l\'envoi', 'אשר שליחה');
  ...
  String get pendingRequestsBadge =>
      _t('solicitudes', 'requests', 'demandes', 'בקשות');
  ...
  String get prayerTitleEs => _t(
    'DIOS DE (RABINO) MEIR, RESPÓNDEME',
    'GOD OF (RABBI) MEIR, ANSWER ME',
    'DIEU DE (RABBI) MEIR, RÉPONDS-MOI',
    'אלהא דמאיר ענני',
  );
  ...
  String get myOrganizations => _t(
    'Mis organizaciones',
    'My organizations',
    'Mes organisations',
    'הארגונים שלי',
  );
  String get addOrganization => _t(
    'Agregar organización',
    'Add organization',
    'Ajouter une organisation',
    'הוסף ארגון',
  );
  String get switchOrganization => _t(
  ...
  String get confirmPaymentTitle => _t(
    'Confirmar donación',
    'Confirm donation',
    'Confirmer le don',
    'אשר תרומה',
  ...
  String get confirmDonate =>
      _t('Sí, donar', 'Yes, donate', 'Oui, donner', 'כן, תרום');
  ...
  String get onboardingDone =>
      _t('¡Comenzar!', 'Get started!', 'Commencer !', 'בואו נתחיל!');
  String get onboarding1Title => _t(
    'Bienvenido a Pushka',
    'Welcome to Pushka',
    'Bienvenue sur Pushka',
    'ברוכים הבאים לפושקה',
  );
  ...
  String get chartTitle => _t(
    'DONACIONES POR MES',
    'MONTHLY DONATIONS',
    'DONS MENSUELS',
    'תרומות חודשיות',
  );
  String get chartShowGraph =>
      _t('Ver gráfico', 'Show chart', 'Afficher le graphique', 'הצג גרף');
  String get chartHideGraph =>
      _t('Ocultar gráfico', 'Hide chart', 'Masquer le graphique', 'הסתר גרף');
  String get chartNoData => _t(
    'Sin datos aún',
    'No data yet',
  ...
  String get editProfileTitle =>
      _t('Editar perfil', 'Edit profile', 'Modifier le profil', 'ערוך פרופיל');
  ...
  String get editNameTooltip =>
      _t('Editar nombre', 'Edit name', 'Modifier le nom', 'ערוך שם');
  String get changePhoto =>
      _t('Cambiar foto', 'Change photo', 'Changer la photo', 'שנה תמונה');
  String get uploadingPhoto => _t(
    'Subiendo foto...',
    'Uploading photo...',
    'Envoi de la photo...',
    'מעלה תמונה...',
  ...
  String get couldNotUploadPhoto => _t(
    'No se pudo subir la foto',
    'Could not upload photo',
    "Impossible de télécharger la photo",
    'לא ניתן להעלות את התמונה',
  );
  ...
  String get myCards =>
      _t('Mis tarjetas', 'My cards', 'Mes cartes', 'הכרטיסים שלי');
  ...
  String get changeCard =>
      _t('Cambiar tarjeta', 'Change card', 'Changer de carte', 'החלף כרטיס');
  ...
  String get addCard =>
      _t('Agregar tarjeta', 'Add card', 'Ajouter une carte', 'הוסף כרטיס');
  String get cardDefault =>
      _t('Predeterminada', 'Default', 'Par défaut', 'ברירת מחדל');
  String get setAsDefault => _t(
  ...
  String get deleteCard =>
      _t('Eliminar tarjeta', 'Delete card', 'Supprimer la carte', 'מחק כרטיס');
  String cardEndingIn(String last4) => _t(
    'Terminada en $last4',
    'Ending in $last4',
    'Se terminant par $last4',
    'מסתיים ב-$last4',
  );
  String cardExpiry(String month, String year) => _t(
    'Vence $month/$year',
    'Expires $month/$year',
    'Expire $month/$year',
    'פג תוקף $month/$year',
  );
  String get cardAdded => _t(
  ...
  String get cardDeleted =>
      _t('Tarjeta eliminada', 'Card deleted', 'Carte supprimée', 'הכרטיס נמחק');
  String get cardSetAsDefault => _t(
  ...
  String get loadingCards => _t(
    'Cargando tarjetas...',
    'Loading cards...',
    'Chargement des cartes...',
    'טוען כרטיסים...',
  );
  String get errorLoadingCards => _t(
    'Error al cargar las tarjetas',
    'Error loading cards',
    'Erreur lors du chargement des cartes',
    'שגיאה בטעינת כרטיסים',
  );
  ...
  String get pushNotifications =>
      _t('Notificaciones', 'Notifications', 'Notifications', 'התראות');
  ...
  String get tenantEnterCode =>
      _t('Ingresar código', 'Enter code', 'Saisir le code', 'הזן קוד');
  ...
  String get tenantCodeSignOut =>
      _t('Cerrar sesión', 'Sign out', 'Déconnexion', 'התנתק');
  ...
  String get tenantCodeMailOpenFailed => _t(
    'No se pudo abrir el mail. Escribí a jymmexico@gmail.com.',
    'Could not open mail. Write to jymmexico@gmail.com.',
    'Impossible d\'ouvrir l\'e-mail. Écrivez à jymmexico@gmail.com.',
    'לא ניתן לפתוח את הדוא"ל. כתוב אל jymmexico@gmail.com.',
  );
  ...
  String get tenantJoining =>
      _t('Uniéndote...', 'Joining...', 'Adhésion...', 'מצטרף...');
  String get goHome =>
      _t('Ir al inicio', 'Go home', "Aller à l'accueil", 'עבור לדף הבית');

  String get pushkaStyleLabel => _t(
    'Estilo de pantalla principal',
    'Main screen style',
    'Style de l\'écran principal',
    'סגנון המסך הראשי',
  );
  String get pushkaStyleClassic => _t('Pushka', 'Pushka', 'Pushka', 'פושקה');
  String get pushkaStyleBuilding770 =>
      _t('Edificio 770', 'Building 770', 'Bâtiment 770', 'בניין 770');
  ...
  String errorWithMessage(String msg) =>
      _t('Error: $msg', 'Error: $msg', 'Erreur : $msg', 'שגיאה: $msg');
