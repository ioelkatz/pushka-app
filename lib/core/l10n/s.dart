...
class S {
  ...
  String get pushkaEmptyHint => _t('Tu pushka está vacía. Agrega algo primero.', 'Your pushka is empty. Add something first.', "Ta pushka est vide. Ajoute quelque chose d'abord.", 'הפושקה שלך ריקה. הוסף משהו קודם.');
  ...
  String get showPassword => _t('Mostrar contraseña', 'Show password', 'Afficher le mot de passe', 'הצג סיסמה');
  String get hidePassword => _t('Ocultar contraseña', 'Hide password', 'Masquer le mot de passe', 'הסתר סיסמה');
